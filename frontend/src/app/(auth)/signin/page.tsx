...
export default function SigninPage() {
  ...
  return (
    ...
    >
      ...
      {/* Form */}
      <form onSubmit={handleSubmit(onSubmit)} className="relative p-10 pt-4 space-y-6">
        {error && (
          <motion.div
        ...
        >
          ...
          <Link href="/signup" className="text-purple-600 font-bold hover:text-pink-600 transition-colors underline-offset-4 hover:underline">
            Sign up
          </Link>
        </motion.p>
      </form>
